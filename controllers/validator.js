...
const bookValidationRules = () => {
  return [
    body('bookTitle').optional().notEmpty().withMessage('Book title is required'),
    ...
    body('shelveLocation').optional().notEmpty().withMessage('Shelve location is required'),
    body('genre').optional().notEmpty().withMessage('Genre is required'),
    body('copiesAvailable').optional().isInt({ min: 0 }).withMessage('Copies available must be a positive integer'),
...
const playerValidationRules = () => {
  return [
    body('firstName').optional().notEmpty().withMessage('First name is required'),
    body('lastName').optional().notEmpty().withMessage('Last name is required'),
    body('countryName').optional().notEmpty().withMessage('Country is required'),
    body('gender').optional().notEmpty().withMessage('Gender is required'),
    body('age').optional().isInt({ min: 1 }).withMessage('Age must be a positive integer'),
